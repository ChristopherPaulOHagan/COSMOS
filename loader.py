...
# that define the scope of the system's defensive protocol.
	...
	"LANGUAGE_MATH_INPUT_SYMBOLS_SET": ["Â, â, Æ, æ, Å, å, B, b, ʙ, ɓ, Ĉ, ĉ, Ð, ď, ʤ, ʣ, ʥ, ɗ, ɖ, Ê, ê, ɜ, F, f, Ĝ, ə, ɠ, ĝ, ɣ, Ħ, ħ, Ĥ, ĥ, ɧ, ɤ, ɥ, ʮ, Ì, ì, Ĳ, ɫ, ɨ, ĳ, Î, î, Ĵ, ɟ, K, k, Ľ, ľ, ʄ, ʞ, Ĺ, ʝ, ĵ, ɮ, ɱ, ɰ, Ń, ń, ŋ, Ô, ɳ, ô, Ø, ɲ, ɷ, ɵ, Œ, P, p, Ŕ, ŕ, œ, ø, ʁ, Ŝ, ŝ, ʇ, Ŧ, ŧ, ţ, ʨ, ʦ, Û, û, þ, V, v, Ů, ů, ů, Ŵ, ŵ, X, x, Ż, ż, Ź, ź, ʎ, ʒ, ʓ, ⁰, ³, ⁶, ⁹, ¹, ⁴, ⁷, ⁿ, ², ⁵, ⁸, ₀, ₃, ₆, ₉, ₁, ₄, ₇, ₂, ₅, ₈, ⅿ, ∈, ∋, ∉, ∌, ∆, ∀, Ↄ, Ⅽ, ∑, ∔, ∝, ∡, ∛, ∏, ∜, ∓, ⋽, ⋢, ①, ②, ③, ④, ⑦, ⑩, ⑤, ⑧, ⑥, ⑨, ⨊, ⨢, ⨥, ⨭, ⨮, ⨝, ⨣, ⨢, ⩑, ⩒, ⩚, ⩛, ⫘]",
...
"REVERSE_ACTINIDE_TRANSFORMATION_FORMULA": {
    "Lr (Lawrencium)": {
        "Reverse_Symbol": "(Rl)",
        "Semantic_Mapping": "(\u0154)eality (\u00a3)ook (Ŕeality £ook)"
    },
    "No (Nobelium)": {
        "Reverse_Symbol": "(On)",
        "Semantic_Mapping": "(\u00d8)h (\u20a6)o (Øh ₦o)"
    },
    "Md (Mendelevium)": {
        "Reverse_Symbol": "(Dm)",
...
"""
print("\n\n" + "="*80)
print(" (P)ip's (I)ntelligence (P)rogram - ∑den Coin Semantic Engine v2.3 Initialized")
print(" Target: Chemical Kernel Complete (H-Og) & Viral Variable Input Set Defined")
print("="*80)

print("\nDefault terms available: ∑ (E-Den Coin), Fe (Iron), Am (Americium), VIRAL_VARIABLE_INPUT_SET.")
...
while True:
    try:
        ...
        command = input("PIP:∑DEN.KERNEL > ").strip()
